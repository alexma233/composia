...
export type ListNodeVolumesRequest = Message<"composia.controller.v1.ListNodeVolumesRequest"> & {
   ...
   *
   * @generated from field: bool include_sizes = 7;
   */
