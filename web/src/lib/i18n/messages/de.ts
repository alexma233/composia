...
export const de = {
  ...
  services: {
    ...
    instances: {
      ...
      pendingDeployCommit: "Commit {revision}",
    },
    allNodes: "Alle Nodes",
  ...
  tasks: {
    ...
    steps: {
      unspecified: "Unbekannter Schritt",
      render: "Konfiguration rendern",
      pull: "Images abrufen",
      backup: "Daten sichern",
      composeDown: "Compose herunterfahren",
      composeUp: "Compose starten",
      transfer: "Daten übertragen",
      restore: "Daten wiederherstellen",
      dnsUpdate: "DNS aktualisieren",
      caddySync: "Caddy synchronisieren",
      caddyReload: "Caddy neu laden",
      imageCheck: "Image prüfen",
      init: "Initialisieren",
      prune: "Bereinigen",
      awaitingConfirmation: "Wartet auf Bestätigung",
      persistRepo: "Repo speichern",
      finalize: "Abschließen",
      dockerStart: "Container starten",
      dockerStop: "Container stoppen",
      dockerRestart: "Container neu starten",
      dockerRemove: "Docker-Objekt entfernen",
      cloudflareTunnelSync: "Cloudflare Tunnel synchronisieren",
    },
    filters: {
    ...
    taskLogs: "Task-Logs",
    accessibleLogLabel: "Task-Log für Screenreader",
    retryLogStream: "Log-Stream erneut versuchen",
