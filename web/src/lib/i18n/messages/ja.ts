...
export const ja = {
  ...
  services: {
    ...
    instances: {
      ...
      pendingDeployCommit: "コミット {revision}",
    },
    allNodes: "すべてのノード",
  ...
  tasks: {
    ...
    steps: {
      ...
      dnsUpdate: "DNS 更新",
      caddySync: "Caddy 同期",
      caddyReload: "Caddy 再読み込み",
      imageCheck: "イメージ確認",
      init: "初期化",
      prune: "クリーンアップ",
      awaitingConfirmation: "確認待ち",
      persistRepo: "リポジトリを保存",
      finalize: "完了処理",
      dockerStart: "コンテナを起動",
      dockerStop: "コンテナを停止",
      dockerRestart: "コンテナを再起動",
      dockerRemove: "Docker オブジェクトを削除",
      cloudflareTunnelSync: "Cloudflare Tunnel 同期",
    },
    filters: {
      allStatuses: "すべての状態",
    ...
    taskSteps: "タスクステップ",
    taskLogs: "タスクログ",
    accessibleLogLabel: "スクリーンリーダー用タスクログ",
    retryLogStream: "ログストリームを再試行",
    runAgain: "再実行",
    running: "実行中...",
    approve: "承認",
    reject: "却下",
