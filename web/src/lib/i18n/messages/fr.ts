...
export const fr = {
  ...
  tasks: {
    ...
    types: {
      ...
      imageCheck: "Vérification d’image",
      prune: "Docker prune",
    ...
    steps: {
      unspecified: "Étape inconnue",
      render: "Générer la configuration",
      pull: "Récupérer les images",
      backup: "Sauvegarder les données",
      composeDown: "Arrêter Compose",
      composeUp: "Démarrer Compose",
      transfer: "Transférer les données",
      restore: "Restaurer les données",
      dnsUpdate: "Mettre à jour DNS",
      caddySync: "Synchroniser Caddy",
      caddyReload: "Recharger Caddy",
      imageCheck: "Vérifier l’image",
      init: "Initialiser",
      prune: "Nettoyer",
      awaitingConfirmation: "En attente de confirmation",
      persistRepo: "Enregistrer le dépôt",
      finalize: "Finaliser",
      dockerStart: "Démarrer le conteneur",
      dockerStop: "Arrêter le conteneur",
      dockerRestart: "Redémarrer le conteneur",
      dockerRemove: "Supprimer l’objet Docker",
      cloudflareTunnelSync: "Synchroniser Cloudflare Tunnel",
    },
    filters: {
    ...
    accessibleLogLabel: "Journal de tâche pour lecteur d’écran",
    retryLogStream: "Réessayer le flux de journaux",
    runAgain: "Réexécuter",
    running: "En cours...",
    approve: "Approuver",
    reject: "Rejeter",
