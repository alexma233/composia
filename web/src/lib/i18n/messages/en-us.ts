...
export const enUS = {
  ...
  dashboard: {
    ...
    updated: "Updated",
    serviceStatRunning: "{running}/{total} running",
  ...
  services: {
    ...
    noServices: "No services loaded",
    pageDescription:
      "Browse and manage all services with live runtime status, operations, and file editing.",
    ...
    files: {
      ...
      renameFailed: "Failed to rename path.",
      deleteFailed: "Failed to delete path.",
      renameServiceFolderFailed: "Failed to rename service folder.",
      deleteServiceFolderFailed: "Failed to delete service folder.",
    ...
    operations: {
      ...
      backupBeforeUpdate: {
        ...
        default: "Default (use config)",
        forceOn: "Force backup",
        forceOff: "Skip backup",
        triggerForceOn: "Backup",
        triggerForceOff: "Skip",
      },
    ...
    actions: {
      ...
      selectSourceAndTarget: "Select a source node and enter a target node.",
      migrateFailed: "Failed to run migrate.",
    },
    imageUpdates: {
      title: "Image Updates",
      image: "Image",
      ...
      noDetectedAvailable: "No detected updates available.",
    },
  },
  tasks: {
    title: "Tasks",
    ...
    types: {
      ...
      dockerRemoveContainer: "Remove container",
      dockerRemoveNetwork: "Remove network",
      dockerRemoveVolume: "Remove volume",
      dockerRemoveImage: "Remove image",
    },
    steps: {
      unspecified: "Unknown step",
      ...
      prune: "Prune",
      awaitingConfirmation: "Awaiting confirmation",
      persistRepo: "Persist repo",
      finalize: "Finalize",
      dockerStart: "Start container",
      dockerStop: "Stop container",
      dockerRestart: "Restart container",
      dockerRemove: "Remove Docker object",
      cloudflareTunnelSync: "Cloudflare Tunnel sync",
    },
    filters: {
    ...
    taskLogs: "Task logs",
    accessibleLogLabel: "Screen reader task log",
    retryLogStream: "Retry stream",
    runAgain: "Run Again",
    running: "Running...",
    approve: "Approve",
    reject: "Reject",
    ...
    rollbackFailed: "Failed to create migration rollback.",
  ...
  docker: {
    containers: {
      ...
      countSummary: "Showing {shown} of {total} containers",
