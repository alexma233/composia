...
export const zhHans = {
  ...
  apiError: {
    ...
    unsupportedServiceAction: "不支持的服务操作。",
    invalidConfirmationDecision: "决策必须是 approve 或 reject。",
    serviceNotDeclared: "服务尚未声明。",
    serviceInstanceNotFound: "未找到服务实例。",
    baseRevisionRequired: "需要 base revision。",
    pathRevisionRequired: "需要路径和 base revision。",
    sourceDestRevisionRequired: "需要源路径、目标路径和 base revision。",
    sourceTargetNodeRequired: "需要源节点和目标节点 ID。",
    nodeIdRequired: "需要节点 ID。",
    movePathFailed: "移动路径失败。",
    deletePathFailed: "删除路径失败。",
  ...
  services: {
    ...
    imageUpdates: {
      ...
      noDetectedAvailable: "没有检测到可用的更新。",
    },
  },
  tasks: {
    title: "任务",
    ...
    steps: {
      ...
      pull: "拉取镜像",
      backup: "备份数据",
      composeDown: "Compose 下线",
      composeUp: "Compose 启动",
      transfer: "传输数据",
      restore: "恢复数据",
      dnsUpdate: "DNS 更新",
      caddySync: "Caddy 同步",
    ...
    taskSteps: "任务步骤",
    taskLogs: "任务日志",
    accessibleLogLabel: "屏幕阅读器任务日志",
    retryLogStream: "重试日志流",
    runAgain: "重新运行",
    running: "运行中...",
    approve: "确认继续",
    reject: "验证未通过",
    ...
    rollback: "回滚...",
    rollbackTitle: "迁移回滚",
    rollbackDescription: "选择要执行的恢复动作。清理目标节点暂未开放。",
    rollbackDns: "DNS 回源",
    deploySource: "重新部署源节点服务",
    stopTarget: "停止目标节点服务",
    cleanupTarget: "清理目标节点服务",
    cleanupUnavailable: "清理动作需要明确删除范围后再启用。",
    rollbackCreating: "创建中...",
    rollbackCreate: "创建回滚任务",
    rollbackQueued: "回滚任务已加入队列：{taskId}",
    rollbackFailed: "创建迁移回滚失败。",
  ...
  settings: {
    ...
    controller: {
      ...
      savingConfig: "保存配置中...",
      saveConfig: "保存配置",
      configEditorTitle: "编辑控制器配置",
      configEditorDescription: "仅允许编辑白名单中的非敏感字段。",
      configEditorSaved: "控制器配置已保存，重载已排队。",
      configEditorFailed: "编辑控制器配置失败。",
      configEditorLoadFailed: "加载可编辑控制器配置失败。",
      configEditorSaveFailed: "保存控制器配置失败。",
    },
    repoSync: {
      title: "仓库同步",
      branch: "分支",
