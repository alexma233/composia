...
Setze `agent.repo_dir` in `config.yaml` auf denselben absoluten Pfad.
...
`WEB_LOGIN_PASSWORD_HASH` muss ein Argon2id-PHC-Hash sein. Erzeuge hier einen fertigen `.env`-Eintrag:
