...
Le paquet ou l'archive installe uniquement les binaires Composia. Il n'installe pas Docker, Docker Compose ou Git pour vous.
...
Lorsque vous exécutez le contrôleur ou l'agent en dehors des conteneurs, utilisez votre gestionnaire de services pour les maintenir en cours d'exécution.

Exemple d'unité systemd pour le contrôleur :
...
Exemple d'unité systemd pour l'agent :
...
Adaptez les utilisateurs, groupes, chemins de configuration et permissions du socket Docker à votre environnement.
