...
Feature-specific guides covering how to use each Composia capability:
...
- [Secrets](secrets/) - Age-based encryption for service secret files.
- [Image Updates](image-updates/) - Automatic image update detection and application.
- [Notifications](notifications/) - Alertmanager, SMTP, and Telegram notification channels.
