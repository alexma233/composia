...
Guides par fonctionnalité couvrant l'utilisation de chaque capacité de Composia :
...
- [Secrets](secrets/) — chiffrement basé sur age pour les fichiers de secrets de service.
- [Mises à jour d'images](image-updates/) — détection et application automatiques des mises à jour d'images.
- [Notifications](notifications/) — canaux de notification Alertmanager, SMTP et Telegram.
