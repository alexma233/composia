...
<a name="composia-controller-v1-CreateMigrationRollbackRequest"></a>
...
| ----- | ---- | ----- | ----------- |
| task_id | [string](#string) |  | task_id identifies the original migrate task. |
| rollback_dns | [bool](#bool) |  | rollback_dns syncs DNS back to the source node. |
| deploy_source | [bool](#bool) |  | deploy_source starts the service on the source node again. |
| stop_target | [bool](#bool) |  | stop_target stops the service on the migration target node. |
| cleanup_target | [bool](#bool) |  | cleanup_target is reserved for a future destructive cleanup workflow. |
