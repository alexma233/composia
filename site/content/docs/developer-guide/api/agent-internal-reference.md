---
title: "Agent Internal Reference"
weight: 10
---
...
- [proto/composia/agent/v1/agent.proto](#proto_composia_agent_v1_agent-proto)
    ...
    - [DockerQueryRunContainerExecRequest](#composia-agent-v1-DockerQueryRunContainerExecRequest)
    - [DockerQueryRunContainerExecResponse](#composia-agent-v1-DockerQueryRunContainerExecResponse)
    ...
    - [ReportServiceImageUpdateChecksResponse](#composia-agent-v1-ReportServiceImageUpdateChecksResponse)
    ...
    - [AgentTaskStatus](#composia-agent-v1-AgentTaskStatus)
    - [AgentTaskStepName](#composia-agent-v1-AgentTaskStepName)
    - [AgentTaskType](#composia-agent-v1-AgentTaskType)
    - [ContainerAction](#composia-agent-v1-ContainerAction)
    - [DockerQueryErrorCode](#composia-agent-v1-DockerQueryErrorCode)
...
| type | [AgentTaskType](#composia-agent-v1-AgentTaskType) |  | type identifies the task kind assigned by the controller. |
...
<a name="composia-agent-v1-DockerQueryRunContainerExecRequest"></a>
...
| max_output_bytes | [uint64](#uint64) |  |  |
...
<a name="composia-agent-v1-DockerQueryRunContainerExecResponse"></a>
...
| list_containers | [ListContainersRequest](#composia-agent-v1-ListContainersRequest) |  |  |
| inspect_container | [InspectContainerRequest](#composia-agent-v1-InspectContainerRequest) |  |  |
| list_networks | [ListNetworksRequest](#composia-agent-v1-ListNetworksRequest) |  |  |
| inspect_network | [InspectNetworkRequest](#composia-agent-v1-InspectNetworkRequest) |  |  |
| list_volumes | [ListVolumesRequest](#composia-agent-v1-ListVolumesRequest) |  |  |
...
| list_containers | [ListContainersResponse](#composia-agent-v1-ListContainersResponse) |  |  |
| inspect_container | [InspectContainerResponse](#composia-agent-v1-InspectContainerResponse) |  |  |
| list_networks | [ListNetworksResponse](#composia-agent-v1-ListNetworksResponse) |  |  |
| inspect_network | [InspectNetworkResponse](#composia-agent-v1-InspectNetworkResponse) |  |  |
| list_volumes | [ListVolumesResponse](#composia-agent-v1-ListVolumesResponse) |  |  |
...
<a name="composia-agent-v1-ReportServiceImageStatesResponse"></a>
...
<a name="composia-agent-v1-ReportServiceImageUpdateChecksRequest"></a>
...
<a name="composia-agent-v1-ReportServiceImageUpdateChecksResponse"></a>
...
| ----- | ---- | ----- | ----------- |
| task_id | [string](#string) |  | task_id is the controller task ID being updated. |
| step_name | [AgentTaskStepName](#composia-agent-v1-AgentTaskStepName) |  | step_name identifies the step being updated. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| compose_service | [string](#string) |  |  |
| image_ref | [string](#string) |  |  |
| local_digest | [string](#string) |  |  |
| remote_digest | [string](#string) |  |  |
| local_digest_observed | [bool](#bool) |  |  |
| remote_digest_observed | [bool](#bool) |  |  |
...
<a name="composia-agent-v1-ServiceImageUpdateCheck"></a>
...
<a name="composia-agent-v1-AgentTaskStatus"></a>
...
<a name="composia-agent-v1-AgentTaskStepName"></a>
...
<a name="composia-agent-v1-AgentTaskType"></a>
...
<a name="composia-agent-v1-DockerQueryErrorCode"></a>
