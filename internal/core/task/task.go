...
const (
	...
	TypeDockerRemoveContainer Type = "docker_remove_container"
	TypeDockerRemoveNetwork   Type = "docker_remove_network"
	TypeDockerRemoveVolume    Type = "docker_remove_volume"
	TypeDockerRemoveImage     Type = "docker_remove_image"
