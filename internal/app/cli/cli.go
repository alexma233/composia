...
var commandUsages = map[string]string{ //nolint:gosec
	...
	"rustic forget":         "usage: composia rustic forget [--yes] [--wait] [--follow] [--timeout duration] [--service name] [--data name] <node>\n",
	"rustic prune":          "usage: composia rustic prune [--yes] [--wait] [--follow] [--timeout duration] [--service name] [--data name] <node>\n",
