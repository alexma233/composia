...
hero:
  name: "Composia"
  text: "Multi-Node Docker Compose"
  tagline: Deploy Compose files to many nodes. You keep full control.
  actions:
    - theme: brand
      text: Quick Start
...
features:
  ...
  - title: 🎛️ Centralized Dashboard
    details: Coordinate services, nodes, tasks, and state from one place while preserving direct access to the underlying system.
  ...
  - title: 🚫 No Platform Lock-In
    details: Composia coordinates and reports, but it does not take ownership of your infrastructure away from the operator.
---
