...
type GetTaskResponse struct {
	...
	ExecutionState string                 `protobuf:"bytes,17,opt,name=execution_state,json=executionState,proto3" json:"execution_state,omitempty"`
...
func (x *GetTaskResponse) GetExecutionState() string {
	if x != nil {
...
func (x *GetTaskResponse) GetLeaseExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
type FailLostTaskExecutionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TaskId        string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
...
func (x *FailLostTaskExecutionRequest) Reset() {
	*x = FailLostTaskExecutionRequest{}
	mi := &file_proto_composia_controller_v1_task_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FailLostTaskExecutionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailLostTaskExecutionRequest) ProtoMessage() {}

func (x *FailLostTaskExecutionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_composia_controller_v1_task_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailLostTaskExecutionRequest.ProtoReflect.Descriptor instead.
func (*FailLostTaskExecutionRequest) Descriptor() ([]byte, []int) {
	return file_proto_composia_controller_v1_task_proto_rawDescGZIP(), []int{7}
}

func (x *FailLostTaskExecutionRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *FailLostTaskExecutionRequest) GetErrorSummary() string {
	if x != nil {
		return x.ErrorSummary
	}
	return ""
...
func (x *CreateMigrationRollbackRequest) Reset() {
	*x = CreateMigrationRollbackRequest{}
	mi := &file_proto_composia_controller_v1_task_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateMigrationRollbackRequest) Descriptor() ([]byte, []int) {
	return file_proto_composia_controller_v1_task_proto_rawDescGZIP(), []int{12}
}
...
const file_proto_composia_controller_v1_task_proto_rawDesc = "" +
	...
	"\x12attempt_of_task_id\x18\x10 \x01(\tR\x0fattemptOfTaskId\x12'\n" +
	"\x0fexecution_state\x18\x11 \x01(\tR\x0eexecutionState\x12D\n" +
	"\x10lease_expires_at\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\x0eleaseExpiresAtJ\x04\b\f\x10\r\"\\\n" +
	"\x1cFailLostTaskExecutionRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12#\n" +
	"\rerror_summary\x18\x02 \x01(\tR\ferrorSummary\".\n" +
	...
	"!TASK_CONFIRMATION_DECISION_REJECT\x10\x022\x9a\x06\n" +
	"\vTaskService\x12`\n" +
	...
	"\fRunTaskAgain\x12+.composia.controller.v1.RunTaskAgainRequest\x1a*.composia.controller.v1.TaskActionResponse\x12y\n" +
	"\x15FailLostTaskExecution\x124.composia.controller.v1.FailLostTaskExecutionRequest\x1a*.composia.controller.v1.TaskActionResponse\x12}\n" +
...
var file_proto_composia_controller_v1_task_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_proto_composia_controller_v1_task_proto_goTypes = []any{
	...
	(*FailLostTaskExecutionRequest)(nil),   // 12: composia.controller.v1.FailLostTaskExecutionRequest
	(*TailTaskLogsRequest)(nil),            // 13: composia.controller.v1.TailTaskLogsRequest
	(*TailTaskLogsResponse)(nil),           // 14: composia.controller.v1.TailTaskLogsResponse
	(*RunTaskAgainRequest)(nil),            // 15: composia.controller.v1.RunTaskAgainRequest
	(*ResolveTaskConfirmationRequest)(nil), // 16: composia.controller.v1.ResolveTaskConfirmationRequest
	(*CreateMigrationRollbackRequest)(nil), // 17: composia.controller.v1.CreateMigrationRollbackRequest
...
var file_proto_composia_controller_v1_task_proto_depIdxs = []int32{
	...
	18, // 7: composia.controller.v1.TaskSummary.created_at:type_name -> google.protobuf.Timestamp
	...
	18, // 11: composia.controller.v1.TaskStepSummary.started_at:type_name -> google.protobuf.Timestamp
	18, // 12: composia.controller.v1.TaskStepSummary.finished_at:type_name -> google.protobuf.Timestamp
	...
	18, // 16: composia.controller.v1.GetTaskResponse.created_at:type_name -> google.protobuf.Timestamp
	18, // 17: composia.controller.v1.GetTaskResponse.started_at:type_name -> google.protobuf.Timestamp
	18, // 18: composia.controller.v1.GetTaskResponse.finished_at:type_name -> google.protobuf.Timestamp
	10, // 19: composia.controller.v1.GetTaskResponse.steps:type_name -> composia.controller.v1.TaskStepSummary
	18, // 20: composia.controller.v1.GetTaskResponse.lease_expires_at:type_name -> google.protobuf.Timestamp
	4,  // 21: composia.controller.v1.ResolveTaskConfirmationRequest.decision:type_name -> composia.controller.v1.TaskConfirmationDecision
	6,  // 22: composia.controller.v1.TaskService.ListTasks:input_type -> composia.controller.v1.ListTasksRequest
	9,  // 23: composia.controller.v1.TaskService.GetTask:input_type -> composia.controller.v1.GetTaskRequest
	13, // 24: composia.controller.v1.TaskService.TailTaskLogs:input_type -> composia.controller.v1.TailTaskLogsRequest
	15, // 25: composia.controller.v1.TaskService.RunTaskAgain:input_type -> composia.controller.v1.RunTaskAgainRequest
	12, // 26: composia.controller.v1.TaskService.FailLostTaskExecution:input_type -> composia.controller.v1.FailLostTaskExecutionRequest
	16, // 27: composia.controller.v1.TaskService.ResolveTaskConfirmation:input_type -> composia.controller.v1.ResolveTaskConfirmationRequest
	17, // 28: composia.controller.v1.TaskService.CreateMigrationRollback:input_type -> composia.controller.v1.CreateMigrationRollbackRequest
	8,  // 29: composia.controller.v1.TaskService.ListTasks:output_type -> composia.controller.v1.ListTasksResponse
	11, // 30: composia.controller.v1.TaskService.GetTask:output_type -> composia.controller.v1.GetTaskResponse
	14, // 31: composia.controller.v1.TaskService.TailTaskLogs:output_type -> composia.controller.v1.TailTaskLogsResponse
	5,  // 32: composia.controller.v1.TaskService.RunTaskAgain:output_type -> composia.controller.v1.TaskActionResponse
	5,  // 33: composia.controller.v1.TaskService.FailLostTaskExecution:output_type -> composia.controller.v1.TaskActionResponse
	5,  // 34: composia.controller.v1.TaskService.ResolveTaskConfirmation:output_type -> composia.controller.v1.TaskActionResponse
	5,  // 35: composia.controller.v1.TaskService.CreateMigrationRollback:output_type -> composia.controller.v1.TaskActionResponse
