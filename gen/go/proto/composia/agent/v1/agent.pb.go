...
const file_proto_composia_agent_v1_agent_proto_rawDesc = "" +
	...
	"\rerror_summary\x18\b \x01(\tR\ferrorSummary\"\xd8\x01\n" +
	...
	"\vreported_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"reportedAt\"\"\n" +
	" ReportServiceImageStatesResponse\"S\n" +
	...
	"\x18CONTAINER_ACTION_RESTART\x10\x032\xa1\n" +
	"\n" +
	...
	"\x18ReportServiceImageStates\x122.composia.agent.v1.ReportServiceImageStatesRequest\x1a3.composia.agent.v1.ReportServiceImageStatesResponse\x12n\n" +
	...
	"\x16OpenContainerLogTunnel\x120.composia.agent.v1.OpenContainerLogTunnelRequest\x1a1.composia.agent.v1.OpenContainerLogTunnelResponse(\x010\x012\xe9\x01\n" +
...
var file_proto_composia_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_proto_composia_agent_v1_agent_proto_goTypes = []any{
	...
	(*GetServiceBundleRequest)(nil),             // 27: composia.agent.v1.GetServiceBundleRequest
	(*GetServiceBundleResponse)(nil),            // 28: composia.agent.v1.GetServiceBundleResponse
	(*DockerStats)(nil),                         // 29: composia.agent.v1.DockerStats
	(*ReportDockerStatsRequest)(nil),            // 30: composia.agent.v1.ReportDockerStatsRequest
	(*ReportDockerStatsResponse)(nil),           // 31: composia.agent.v1.ReportDockerStatsResponse
	(*ReportDockerQueryResultRequest)(nil),      // 32: composia.agent.v1.ReportDockerQueryResultRequest
	(*ReportDockerQueryResultResponse)(nil),     // 33: composia.agent.v1.ReportDockerQueryResultResponse
	(*ListContainersRequest)(nil),               // 34: composia.agent.v1.ListContainersRequest
	(*ContainerInfo)(nil),                       // 35: composia.agent.v1.ContainerInfo
	(*ListContainersResponse)(nil),              // 36: composia.agent.v1.ListContainersResponse
	(*InspectContainerRequest)(nil),             // 37: composia.agent.v1.InspectContainerRequest
	(*InspectContainerResponse)(nil),            // 38: composia.agent.v1.InspectContainerResponse
	(*RunContainerActionRequest)(nil),           // 39: composia.agent.v1.RunContainerActionRequest
	(*RunContainerActionResponse)(nil),          // 40: composia.agent.v1.RunContainerActionResponse
	(*RemoveContainerRequest)(nil),              // 41: composia.agent.v1.RemoveContainerRequest
	(*RemoveContainerResponse)(nil),             // 42: composia.agent.v1.RemoveContainerResponse
	(*GetContainerLogsRequest)(nil),             // 43: composia.agent.v1.GetContainerLogsRequest
	(*GetContainerLogsResponse)(nil),            // 44: composia.agent.v1.GetContainerLogsResponse
	(*ListNetworksRequest)(nil),                 // 45: composia.agent.v1.ListNetworksRequest
	(*NetworkInfo)(nil),                         // 46: composia.agent.v1.NetworkInfo
	(*ListNetworksResponse)(nil),                // 47: composia.agent.v1.ListNetworksResponse
	(*InspectNetworkRequest)(nil),               // 48: composia.agent.v1.InspectNetworkRequest
	(*InspectNetworkResponse)(nil),              // 49: composia.agent.v1.InspectNetworkResponse
	(*RemoveNetworkRequest)(nil),                // 50: composia.agent.v1.RemoveNetworkRequest
	(*RemoveNetworkResponse)(nil),               // 51: composia.agent.v1.RemoveNetworkResponse
	(*ListVolumesRequest)(nil),                  // 52: composia.agent.v1.ListVolumesRequest
	(*VolumeInfo)(nil),                          // 53: composia.agent.v1.VolumeInfo
	(*ListVolumesResponse)(nil),                 // 54: composia.agent.v1.ListVolumesResponse
	(*InspectVolumeRequest)(nil),                // 55: composia.agent.v1.InspectVolumeRequest
	(*InspectVolumeResponse)(nil),               // 56: composia.agent.v1.InspectVolumeResponse
	(*RemoveVolumeRequest)(nil),                 // 57: composia.agent.v1.RemoveVolumeRequest
	(*RemoveVolumeResponse)(nil),                // 58: composia.agent.v1.RemoveVolumeResponse
	(*ListImagesRequest)(nil),                   // 59: composia.agent.v1.ListImagesRequest
	(*ImageInfo)(nil),                           // 60: composia.agent.v1.ImageInfo
	(*ListImagesResponse)(nil),                  // 61: composia.agent.v1.ListImagesResponse
	(*InspectImageRequest)(nil),                 // 62: composia.agent.v1.InspectImageRequest
	(*InspectImageResponse)(nil),                // 63: composia.agent.v1.InspectImageResponse
	(*RemoveImageRequest)(nil),                  // 64: composia.agent.v1.RemoveImageRequest
	(*RemoveImageResponse)(nil),                 // 65: composia.agent.v1.RemoveImageResponse
	nil,                                         // 66: composia.agent.v1.ContainerInfo.LabelsEntry
	nil,                                         // 67: composia.agent.v1.NetworkInfo.LabelsEntry
	nil,                                         // 68: composia.agent.v1.VolumeInfo.LabelsEntry
	(*timestamppb.Timestamp)(nil),               // 69: google.protobuf.Timestamp
}
var file_proto_composia_agent_v1_agent_proto_depIdxs = []int32{
	69, // 0: composia.agent.v1.HeartbeatRequest.sent_at:type_name -> google.protobuf.Timestamp
	2,  // 1: composia.agent.v1.HeartbeatRequest.runtime:type_name -> composia.agent.v1.NodeRuntimeSummary
	69, // 2: composia.agent.v1.HeartbeatResponse.received_at:type_name -> google.protobuf.Timestamp
	...
	69, // 5: composia.agent.v1.ReportTaskStateRequest.finished_at:type_name -> google.protobuf.Timestamp
	69, // 6: composia.agent.v1.ReportTaskStepStateRequest.started_at:type_name -> google.protobuf.Timestamp
	69, // 7: composia.agent.v1.ReportTaskStepStateRequest.finished_at:type_name -> google.protobuf.Timestamp
	69, // 8: composia.agent.v1.UploadTaskLogsRequest.sent_at:type_name -> google.protobuf.Timestamp
	69, // 9: composia.agent.v1.ReportBackupResultRequest.started_at:type_name -> google.protobuf.Timestamp
	69, // 10: composia.agent.v1.ReportBackupResultRequest.finished_at:type_name -> google.protobuf.Timestamp
	69, // 11: composia.agent.v1.ReportServiceInstanceStatusRequest.reported_at:type_name -> google.protobuf.Timestamp
	24, // 12: composia.agent.v1.ReportServiceImageStatesRequest.images:type_name -> composia.agent.v1.ServiceImageState
	69, // 13: composia.agent.v1.ReportServiceImageStatesRequest.reported_at:type_name -> google.protobuf.Timestamp
	29, // 14: composia.agent.v1.ReportDockerStatsRequest.stats:type_name -> composia.agent.v1.DockerStats
	66, // 15: composia.agent.v1.ContainerInfo.labels:type_name -> composia.agent.v1.ContainerInfo.LabelsEntry
	35, // 16: composia.agent.v1.ListContainersResponse.containers:type_name -> composia.agent.v1.ContainerInfo
	0,  // 17: composia.agent.v1.RunContainerActionRequest.action:type_name -> composia.agent.v1.ContainerAction
	67, // 18: composia.agent.v1.NetworkInfo.labels:type_name -> composia.agent.v1.NetworkInfo.LabelsEntry
	46, // 19: composia.agent.v1.ListNetworksResponse.networks:type_name -> composia.agent.v1.NetworkInfo
	68, // 20: composia.agent.v1.VolumeInfo.labels:type_name -> composia.agent.v1.VolumeInfo.LabelsEntry
	53, // 21: composia.agent.v1.ListVolumesResponse.volumes:type_name -> composia.agent.v1.VolumeInfo
	60, // 22: composia.agent.v1.ListImagesResponse.images:type_name -> composia.agent.v1.ImageInfo
	1,  // 23: composia.agent.v1.AgentReportService.Heartbeat:input_type -> composia.agent.v1.HeartbeatRequest
	10, // 24: composia.agent.v1.AgentReportService.ReportTaskState:input_type -> composia.agent.v1.ReportTaskStateRequest
	12, // 25: composia.agent.v1.AgentReportService.ReportTaskStepState:input_type -> composia.agent.v1.ReportTaskStepStateRequest
	14, // 26: composia.agent.v1.AgentReportService.UploadTaskLogs:input_type -> composia.agent.v1.UploadTaskLogsRequest
	20, // 27: composia.agent.v1.AgentReportService.ReportBackupResult:input_type -> composia.agent.v1.ReportBackupResultRequest
	22, // 28: composia.agent.v1.AgentReportService.ReportServiceInstanceStatus:input_type -> composia.agent.v1.ReportServiceInstanceStatusRequest
	25, // 29: composia.agent.v1.AgentReportService.ReportServiceImageStates:input_type -> composia.agent.v1.ReportServiceImageStatesRequest
	30, // 30: composia.agent.v1.AgentReportService.ReportDockerStats:input_type -> composia.agent.v1.ReportDockerStatsRequest
	32, // 31: composia.agent.v1.AgentReportService.ReportDockerQueryResult:input_type -> composia.agent.v1.ReportDockerQueryResultRequest
	16, // 32: composia.agent.v1.AgentReportService.OpenExecTunnel:input_type -> composia.agent.v1.OpenExecTunnelRequest
	18, // 33: composia.agent.v1.AgentReportService.OpenContainerLogTunnel:input_type -> composia.agent.v1.OpenContainerLogTunnelRequest
	4,  // 34: composia.agent.v1.AgentTaskService.PullNextTask:input_type -> composia.agent.v1.PullNextTaskRequest
	8,  // 35: composia.agent.v1.AgentTaskService.PullNextDockerQuery:input_type -> composia.agent.v1.PullNextDockerQueryRequest
	27, // 36: composia.agent.v1.BundleService.GetServiceBundle:input_type -> composia.agent.v1.GetServiceBundleRequest
	34, // 37: composia.agent.v1.DockerService.ListContainers:input_type -> composia.agent.v1.ListContainersRequest
	37, // 38: composia.agent.v1.DockerService.InspectContainer:input_type -> composia.agent.v1.InspectContainerRequest
	39, // 39: composia.agent.v1.DockerService.RunContainerAction:input_type -> composia.agent.v1.RunContainerActionRequest
	41, // 40: composia.agent.v1.DockerService.RemoveContainer:input_type -> composia.agent.v1.RemoveContainerRequest
	43, // 41: composia.agent.v1.DockerService.GetContainerLogs:input_type -> composia.agent.v1.GetContainerLogsRequest
	45, // 42: composia.agent.v1.DockerService.ListNetworks:input_type -> composia.agent.v1.ListNetworksRequest
	48, // 43: composia.agent.v1.DockerService.InspectNetwork:input_type -> composia.agent.v1.InspectNetworkRequest
	50, // 44: composia.agent.v1.DockerService.RemoveNetwork:input_type -> composia.agent.v1.RemoveNetworkRequest
	52, // 45: composia.agent.v1.DockerService.ListVolumes:input_type -> composia.agent.v1.ListVolumesRequest
	55, // 46: composia.agent.v1.DockerService.InspectVolume:input_type -> composia.agent.v1.InspectVolumeRequest
	57, // 47: composia.agent.v1.DockerService.RemoveVolume:input_type -> composia.agent.v1.RemoveVolumeRequest
	59, // 48: composia.agent.v1.DockerService.ListImages:input_type -> composia.agent.v1.ListImagesRequest
	62, // 49: composia.agent.v1.DockerService.InspectImage:input_type -> composia.agent.v1.InspectImageRequest
	64, // 50: composia.agent.v1.DockerService.RemoveImage:input_type -> composia.agent.v1.RemoveImageRequest
	3,  // 51: composia.agent.v1.AgentReportService.Heartbeat:output_type -> composia.agent.v1.HeartbeatResponse
	11, // 52: composia.agent.v1.AgentReportService.ReportTaskState:output_type -> composia.agent.v1.ReportTaskStateResponse
	13, // 53: composia.agent.v1.AgentReportService.ReportTaskStepState:output_type -> composia.agent.v1.ReportTaskStepStateResponse
	15, // 54: composia.agent.v1.AgentReportService.UploadTaskLogs:output_type -> composia.agent.v1.UploadTaskLogsResponse
	21, // 55: composia.agent.v1.AgentReportService.ReportBackupResult:output_type -> composia.agent.v1.ReportBackupResultResponse
	23, // 56: composia.agent.v1.AgentReportService.ReportServiceInstanceStatus:output_type -> composia.agent.v1.ReportServiceInstanceStatusResponse
	26, // 57: composia.agent.v1.AgentReportService.ReportServiceImageStates:output_type -> composia.agent.v1.ReportServiceImageStatesResponse
	31, // 58: composia.agent.v1.AgentReportService.ReportDockerStats:output_type -> composia.agent.v1.ReportDockerStatsResponse
	33, // 59: composia.agent.v1.AgentReportService.ReportDockerQueryResult:output_type -> composia.agent.v1.ReportDockerQueryResultResponse
	17, // 60: composia.agent.v1.AgentReportService.OpenExecTunnel:output_type -> composia.agent.v1.OpenExecTunnelResponse
	19, // 61: composia.agent.v1.AgentReportService.OpenContainerLogTunnel:output_type -> composia.agent.v1.OpenContainerLogTunnelResponse
	6,  // 62: composia.agent.v1.AgentTaskService.PullNextTask:output_type -> composia.agent.v1.PullNextTaskResponse
	9,  // 63: composia.agent.v1.AgentTaskService.PullNextDockerQuery:output_type -> composia.agent.v1.PullNextDockerQueryResponse
	28, // 64: composia.agent.v1.BundleService.GetServiceBundle:output_type -> composia.agent.v1.GetServiceBundleResponse
	36, // 65: composia.agent.v1.DockerService.ListContainers:output_type -> composia.agent.v1.ListContainersResponse
	38, // 66: composia.agent.v1.DockerService.InspectContainer:output_type -> composia.agent.v1.InspectContainerResponse
	40, // 67: composia.agent.v1.DockerService.RunContainerAction:output_type -> composia.agent.v1.RunContainerActionResponse
	42, // 68: composia.agent.v1.DockerService.RemoveContainer:output_type -> composia.agent.v1.RemoveContainerResponse
	44, // 69: composia.agent.v1.DockerService.GetContainerLogs:output_type -> composia.agent.v1.GetContainerLogsResponse
	47, // 70: composia.agent.v1.DockerService.ListNetworks:output_type -> composia.agent.v1.ListNetworksResponse
	49, // 71: composia.agent.v1.DockerService.InspectNetwork:output_type -> composia.agent.v1.InspectNetworkResponse
	51, // 72: composia.agent.v1.DockerService.RemoveNetwork:output_type -> composia.agent.v1.RemoveNetworkResponse
	54, // 73: composia.agent.v1.DockerService.ListVolumes:output_type -> composia.agent.v1.ListVolumesResponse
	56, // 74: composia.agent.v1.DockerService.InspectVolume:output_type -> composia.agent.v1.InspectVolumeResponse
	58, // 75: composia.agent.v1.DockerService.RemoveVolume:output_type -> composia.agent.v1.RemoveVolumeResponse
	61, // 76: composia.agent.v1.DockerService.ListImages:output_type -> composia.agent.v1.ListImagesResponse
	63, // 77: composia.agent.v1.DockerService.InspectImage:output_type -> composia.agent.v1.InspectImageResponse
	65, // 78: composia.agent.v1.DockerService.RemoveImage:output_type -> composia.agent.v1.RemoveImageResponse
