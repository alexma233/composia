...
This directory contains the source-build `PKGBUILD` used for publishing the `composia` AUR package. Official releases also publish an Arch Linux binary package generated by GoReleaser.
